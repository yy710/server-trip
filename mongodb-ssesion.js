...
module.exports = function (connect) {
    ...
    MongoDBStore.prototype.get = function (id, callback) {
        ...
        this.db.collection(this.options.collection).findOne(this._generateQuery(id), function (error, session) {
            if (error) {
    ...
    MongoDBStore.prototype.destroy = function (id, callback) {
        ...
        this.db.collection(this.options.collection).remove(this._generateQuery(id), function (error) {
            if (error) {
    ...
    MongoDBStore.prototype.clear = function (callback) {
        ...
        this.db.collection(this.options.collection).remove({}, function (error) {
            if (error) {
    ...
    MongoDBStore.prototype.set = function (id, session, callback) {
        ...
        this.db.collection(this.options.collection).update(this._generateQuery(id), s, {upsert: true}, function (error) {
            if (error) {
